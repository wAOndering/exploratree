import os
from exploratree import save_directory_tree_txt, save_directory_tree_yaml, save_all_full_path
...
def main():
	...
	print("\n The traceback below can be ignored \n \n \n")
